...
model = load_model(r'C:\Users\Acer\Downloads\Tugas6_B_11890\Tugas6_B_11890\model_mobilenet.h5')
...
# Streamlit UI
st.title("Prediksi Kematangan Buah Naga - 1890")  # 4 digit npm terakhir
